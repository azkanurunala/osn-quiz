# OSN/KSN SD — MTK · Sub-Bab 03j: Bangun Gabungan (Jumlah) — Luas/Keliling Gabungan (Tingkat Campur)

> **Profil**: 50 Kab + 30 Prov + 20 Nas = 100 soal PG
> **Fokus**: Bangun gabungan dua atau lebih bangun datar; strategi memecah menjadi bangun sederhana; menghitung luas total (jumlahkan semua bagian) dan keliling (hanya garis tepi luar, sisi bertemu tidak dihitung).
...
- **Bagian I — Konsep & Strategi** — definisi bangun gabungan, strategi pemecahan, rumus dasar bangun datar, aturan keliling vs luas, kesalahan umum.
- **Bagian II — 100 Soal PG** — 50 Kab + 30 Prov + 20 Nas, lengkap dengan pembahasan analisis 4 opsi.
...
## 1. Apa itu Bangun Gabungan?

**Bangun gabungan** adalah bangun yang terbentuk dari dua atau lebih bangun datar sederhana yang disatukan. Contoh nyata yang sering muncul:

- **Jendela bertudung**: persegi panjang + setengah lingkaran di atas.
- **Rumah-rumahan sederhana**: persegi panjang (badan) + segitiga (atap).
- **Lantai berbentuk L**: persegi besar dipotong persegi kecil — atau dua persegi panjang yang disatukan.
- **Tangga**: tumpukan beberapa persegi panjang.
- **Lapangan trek lari**: persegi panjang + dua setengah lingkaran di ujung.
- **Taman seperempat lingkaran + persegi**.

## 2. Strategi Umum: PILAH → HITUNG → JUMLAHKAN

Setiap soal bangun gabungan diselesaikan dengan **3 langkah**:

1. **PILAH** — Bagi bangun gabungan menjadi bangun-bangun sederhana (persegi, persegi panjang, segitiga, lingkaran/setengah/seperempat).
2. **HITUNG** — Hitung ukuran (luas atau keliling) tiap bagian sesuai rumus dasar.
3. **JUMLAHKAN** — Total = jumlah semua bagian.

**Tips pilah yang baik**:
- Tarik garis bantu (horizontal/vertikal) supaya tiap bagian jadi bangun yang rumusnya kamu hafal.
- Cari ukuran-ukuran yang TIDAK tertulis tapi bisa dihitung dari ukuran lain (sisi sejajar, simetri).
- Untuk L-shape: dua cara — (a) bagi jadi 2 persegi panjang, atau (b) hitung persegi besar lalu kurangi persegi kecil yang "dipotong". Pilih yang paling mudah.

## 3. Rumus Dasar yang Harus Hafal

| Bangun | Luas | Keliling |
|--------|------|----------|
| Persegi (sisi s) | s × s | 4 × s |
| Persegi panjang (p × l) | p × l | 2 × (p + l) |
| Segitiga (alas a, tinggi t) | ½ × a × t | jumlah 3 sisi |
| Jajar genjang (alas a, tinggi t) | a × t | 2 × (sisi miring + alas) |
| Trapesium | ½ × (a + b) × t | jumlah 4 sisi |
| Belah ketupat (d₁, d₂) | ½ × d₁ × d₂ | 4 × sisi |
| Layang-layang (d₁, d₂) | ½ × d₁ × d₂ | jumlah 4 sisi |
| Lingkaran (jari-jari r) | π × r² | 2 × π × r |
| Setengah lingkaran | ½ × π × r² | π × r + 2r (atau π × r + diameter) |
| Seperempat lingkaran | ¼ × π × r² | ½ × π × r + 2r |

**Nilai π yang lazim dipakai**: 22/7 (jika r kelipatan 7) atau 3,14 (jika r umum).

## 4. Luas Gabungan vs Keliling Gabungan

Ini perbedaan **kunci** yang sering jadi jebakan!

### Luas Gabungan
- **Selalu** jumlahkan luas semua bagian.
- Jika bangun "ditempel" (tidak menumpuk), sisi pertemuan TIDAK mempengaruhi luas — luas tetap dijumlahkan utuh.
- Jika bangun "berlubang" (misal persegi dengan lubang lingkaran di tengah) → luas persegi DIKURANGI luas lingkaran.

### Keliling Gabungan
- Keliling = panjang garis tepi LUAR saja.
- **Sisi yang BERTEMU (di dalam) TIDAK dihitung**, karena bukan tepi luar.
- Selalu telusuri pinggir gambar searah jarum jam, jumlahkan SEMUA segmen luar.

**Ilustrasi**: persegi 6×6 ditempel persegi panjang 4×3 di sisi kanan.
- Luas: 6×6 + 4×3 = 36 + 12 = 48 (jumlahkan semua, sisi tempel tidak mempengaruhi).
- Keliling: telusuri tepi luar. Bukan sekadar (4×6 + 2×(4+3)) = 24 + 14 = 38. Yang benar: tepi luar saja, sisi 3 yang menempel di tengah hanya menyumbang segmen sisa. Hati-hati!

## 5. Contoh-Contoh Bentuk Gabungan Umum

### A. Jendela Bertudung (Persegi panjang + setengah lingkaran)

```
   ___
  /   \      <- setengah lingkaran (jari-jari = ½ lebar persegi panjang)
 |     |
 |     |     <- persegi panjang
 |_____|
```

- Luas = (p × l) + (½ × π × r²) dengan r = l/2 (jika setengah lingkaran di atas).
- Keliling = 2p + l + (½ × keliling lingkaran) = 2p + l + π × r.
  - Sisi atas persegi panjang (panjang l) TIDAK dihitung karena tertutup setengah lingkaran.

### B. Rumah (Persegi panjang + segitiga)
...
- Luas = (p × l) + (½ × alas × tinggi segitiga).
- Keliling = 2 sisi tegak persegi panjang + alas bawah + 2 sisi miring segitiga.
  - Sisi atas persegi panjang (yang menempel ke alas segitiga) TIDAK dihitung.
...
- Luas (cara 1): bagi 2 persegi panjang horizontal/vertikal lalu jumlahkan.
- Luas (cara 2): hitung persegi besar pembungkus, kurangi persegi yang "hilang".
- Keliling: telusuri semua sisi luar — pada L-shape selalu sama dengan keliling persegi panjang pembungkusnya (sifat istimewa L-shape).

### D. Trek Lari (Persegi panjang + 2 setengah lingkaran)

```
  ___________
 (           )    <- 2 setengah lingkaran = 1 lingkaran utuh
  -----------
```

- Luas = (p × l) + (π × r²) dengan r = l/2.
- Keliling = 2p + (2π × r) — sisi sejajar dengan setengah lingkaran tidak dihitung.

### E. Tangga (Susunan persegi panjang)
...
- Luas = jumlah luas tiap anak tangga.
- Keliling tangga (jika dilihat dari samping) = lebar total + tinggi total + jumlah "anak tangga" × (panjang anak + tinggi anak), atau sama dengan keliling persegi panjang pembungkusnya (mirip L-shape, tangga = beberapa "potongan" L).

## 6. Cara Cepat: "Pembungkus dikurangi Lubang"

Untuk **L-shape, T-shape, atau tangga**, sering lebih cepat:

1. Bayangkan persegi panjang **pembungkus** terkecil yang menutup seluruh bangun.
2. Hitung luas pembungkus.
3. Kurangi luas bagian yang "tidak ada" (kosong / dipotong).

Contoh: L-shape 8×7 dengan sudut kanan atas dipotong persegi 3×4.
- Luas = (8 × 7) − (3 × 4) = 56 − 12 = 44.

Untuk **keliling L-shape**, trik: keliling sama dengan keliling pembungkus 8×7 = 2(8+7) = 30. Bagian dipotong tidak menambah/mengurangi keliling karena membentuk "sudut yang sama panjang".

## 7. Aturan Khusus untuk Setengah/Seperempat Lingkaran

- **Setengah lingkaran**:
  - Luas = ½ × π × r².
  - Keliling lengkungan saja = ½ × keliling = π × r.
  - Keliling lengkap (busur + diameter) = π × r + 2r.
- **Seperempat lingkaran**:
  - Luas = ¼ × π × r².
  - Busur saja = ¼ × keliling = ½ × π × r.
  - Keliling lengkap (busur + 2 jari-jari) = ½ × π × r + 2r.

Dalam bangun gabungan, **busur** SELALU masuk hitungan keliling (kalau dia di tepi luar). Diameter atau jari-jari hanya masuk kalau dia ada di tepi luar (tidak menempel bangun lain).

## 8. Kesalahan Umum yang Dijadikan Distractor

1. **Lupa mengurangi sisi yang bertemu pada keliling** — siswa menjumlah keliling tiap bagian utuh, padahal sisi pertemuan harus dikurangi 2× (karena terhitung di kedua bangun).
2. **Lupa membagi 2 atau membagi 4 untuk setengah/seperempat lingkaran** — pakai rumus lingkaran utuh.
3. **Lupa salah satu bagian** — hanya menjumlah 1 bangun, lupa bangun kedua.
4. **Salah pembagian bangun** — memilih garis bantu yang salah sehingga muncul ukuran yang tidak diketahui.
5. **Mengira keliling = jumlah keliling bagian** — padahal harus diperhitungkan sisi yang menempel.
6. **Salah pakai rumus segitiga** — alas/tinggi tidak tegak lurus, atau lupa kali ½.
7. **Salah konversi satuan** — m vs cm, m² vs cm², lupa konversi.
8. **Memasukkan diameter setengah lingkaran yang sebenarnya tertutup persegi panjang** — diameter di tempat pertemuan tidak boleh dihitung pada keliling.

## 9. Strategi Khusus Soal Cerita

- **Gambar dulu** kalau soal hanya berupa deskripsi. Tarik garis bantu untuk memilah.
- **Beri label ukuran** di setiap sisi.
- **Lacak ukuran tersembunyi** — sisi yang tidak ditulis biasanya bisa dihitung dari sisi lawan.
- **Bedakan pertanyaan**: "Luas lantai" → luas; "panjang pagar" / "lis pinggir" → keliling.
- **Konversi satuan di awal** — jangan di akhir.

## 10. Catatan untuk Soal OSN

Soal OSN/KSN sering menggabungkan **lebih dari 2 bangun** (3–4 bangun) dan menanyakan luas/keliling sekaligus. Latihan rutin: kerjakan 3 strategi (pilah, pembungkus−lubang, perpotongan) untuk soal yang sama agar terbiasa memilih cara tercepat.
...
Bagian ini berisi bangun gabungan sederhana (2 bangun), perhitungan langsung, dan cerita pendek. Cocok untuk pemanasan dan penguatan strategi pilah-jumlah.

---

**1.** Sebuah bangun terdiri dari persegi dengan sisi 8 cm dan setengah lingkaran dengan diameter 8 cm yang menempel di sisi atas persegi. Berapakah luas bangun gabungan tersebut? (π = 3,14)
...
**Kunci: A**
**Pembahasan:**
- **A benar** — Bagian 1 (persegi) = 8 × 8 = 64 cm². Bagian 2 (setengah lingkaran, r = 4) = ½ × 3,14 × 4² = ½ × 3,14 × 16 = 25,12 cm². Total = 64 + 25,12 = **89,12 cm²**.
- **B salah** — Hanya menghitung luas persegi, lupa menambahkan setengah lingkaran.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya menghitung persegi panjang, lupa persegi yang disambung.
...
**3.** Sebuah bangun rumah-rumahan terdiri atas persegi panjang berukuran 12 cm × 8 cm (badan rumah) dan segitiga sama kaki (atap) dengan alas 12 cm dan tinggi 5 cm. Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya luas persegi panjang 12 × 8 = 96, lupa segitiga atap.
- **B salah** — Hanya luas segitiga ½ × 12 × 5 = 30, lupa badan persegi panjang.
...
**Kunci: D**
**Pembahasan:**
- **A salah** — Hanya menghitung persegi panjang besar.
...
**5.** Bangun gabungan terdiri atas persegi 10 cm × 10 cm dan setengah lingkaran dengan diameter 10 cm di sisi kanan persegi. Luas total bangun (π = 3,14) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi.
- **B salah** — Hanya setengah lingkaran: ½ × 3,14 × 5² = ½ × 3,14 × 25 = 39,25.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang 14 × 7 = 98.
...
**7.** Bangun gabungan terdiri atas dua persegi panjang yang membentuk huruf T: bagian atas 12 cm × 3 cm, bagian bawah (tengah) 4 cm × 7 cm. Luas total bangun T adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya bagian atas.
- **B salah** — Hanya bagian bawah.
...
**Kunci: B**
**Pembahasan:**
- **A salah** — Hanya luas 1 segitiga: ½ × 10 × 6 = 30.
...
**9.** Sebuah lantai berbentuk L terdiri atas dua persegi panjang: 7 m × 4 m dan 3 m × 4 m. Luas lantai adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya bagian besar.
- **B salah** — Hanya bagian kecil.
...
**11.** Keliling sebuah bangun L yang merupakan persegi 8 cm × 8 cm dengan sudut kanan atas dipotong persegi 3 cm × 3 cm adalah ....
...
**Kunci: A**
**Pembahasan:**
- **A benar** — Keliling L-shape SAMA dengan keliling pembungkus persegi 8 × 8 = 4 × 8 = **32 cm**. Karena potongan sudut menambahkan sisi sebanyak yang dikurangi (3 + 3 = 6 cm masuk, 3 + 3 = 6 cm keluar — saling impas).
- **B salah** — Hanya menjumlah 8+8+5+5 = 26, lupa sisi takikan.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya luas pekarangan utuh.
...
**13.** Bangun gabungan terdiri atas persegi 6 cm × 6 cm dan segitiga sama kaki yang menempel di salah satu sisi persegi dengan alas 6 cm dan tinggi 4 cm. Luas total bangun adalah ....
...
**15.** Bangun terdiri atas persegi panjang 12 cm × 5 cm dan trapesium dengan sisi sejajar 12 cm dan 8 cm serta tinggi 3 cm yang menempel di sisi atas persegi panjang. Luas total bangun adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi panjang.
- **B salah** — Hanya trapesium: ½ × (12+8) × 3 = ½ × 20 × 3 = 30.
...
**17.** Sebuah taman berbentuk seperempat lingkaran dengan jari-jari 14 m disambung dengan persegi panjang 14 m × 10 m. Luas total taman (π = 22/7) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya seperempat lingkaran: ¼ × 22/7 × 196 = 154 m².
- **B salah** — Hanya persegi panjang: 14 × 10 = 140 m².
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang: 70 × 100 = 7000.
...
**19.** Bangun gabungan terdiri atas dua persegi: persegi A bersisi 9 cm dan persegi B bersisi 5 cm yang menempel di sisi persegi A. Luas bangun gabungan adalah ....
...
**Kunci: D**
**Pembahasan:**
- **A salah** — Hanya persegi A.
- **B salah** — Hanya persegi B.
...
**21.** Bangun gabungan dua segitiga: segitiga A alas 8 cm tinggi 5 cm, segitiga B alas 6 cm tinggi 4 cm. Luas total = ....
...
**Kunci: A**
**Pembahasan:**
- **A benar** — Segitiga A = ½ × 8 × 5 = 20 cm². Segitiga B = ½ × 6 × 4 = 12 cm². Total = 20 + 12 = **32 cm²**.
- **B salah** — Hanya menghitung A: 8 × 3 (keliru jadi 24).
...
**23.** Bangun gabungan terdiri atas dua persegi panjang yang membentuk U: alas 12 cm × 4 cm dan 2 tegakan @ 4 cm × 6 cm. Luas total bangun U adalah ....
...
**Kunci: D**
**Pembahasan:**
- **A salah** — Hanya alas: 12 × 4 = 48.
- **B salah** — Hanya 1 tegakan: 4 × 6 = 24.
...
**25.** Sebuah persegi panjang berukuran 20 cm × 10 cm. Di salah satu ujungnya menempel sebuah segitiga siku-siku dengan kaki 10 cm dan 6 cm. Luas total bangun gabungan adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi panjang.
- **B salah** — Hanya segitiga: ½ × 10 × 6 = 30.
...
**27.** Bangun gabungan terdiri atas persegi 12 cm × 12 cm dan setengah lingkaran berdiameter 12 cm yang menempel di sisi bawah persegi. Luas total bangun (π = 3,14) adalah ....
...
**29.** Bangun terdiri atas 3 persegi yang berjajar, masing-masing bersisi 4 cm. Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 1 persegi.
- **B salah** — Hanya 2 persegi.
...
**31.** Sebuah lantai berbentuk persegi panjang 14 m × 10 m dengan sudut kanan atas dipotong segitiga siku-siku berkaki 4 m dan 3 m. Luas lantai yang tersisa adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Lupa pengurangan.
- **B salah** — Hanya segitiga: ½ × 4 × 3 = 6.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya trapesium: ½ × (14+8) × 4 = ½ × 22 × 4 = 44.
...
**33.** Bangun gabungan terdiri atas persegi 8 cm × 8 cm dan 4 segitiga siku-siku kecil identik (kaki 2 cm dan 2 cm) yang menempel di tiap sudut persegi. Luas total bangun adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi.
- **B salah** — Hanya 4 segitiga: 4 × ½ × 2 × 2 = 8.
...
**35.** Bangun gabungan terdiri atas dua persegi yang menempel: persegi A sisi 10 cm, persegi B sisi 6 cm (menempel di sisi kanan A). Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang: 16 × 9 = 144.
...
**37.** Sebuah ruangan berbentuk L: gabungan persegi panjang 12 m × 5 m dan 6 m × 5 m. Luas ruangan adalah ....
...
**39.** Sebuah bangun terdiri atas 2 setengah lingkaran identik dengan jari-jari 5 cm yang disatukan membentuk lingkaran utuh. Luas total bangun (π = 3,14) adalah ....
...
**Kunci: A**
**Pembahasan:**
- **A benar** — 2 setengah lingkaran = 1 lingkaran utuh r = 5: 3,14 × 25 = **78,5 cm²**.
- **B salah** — Hanya 1 setengah lingkaran: ½ × 3,14 × 25 = 39,25.
...
**41.** Bangun terdiri atas persegi sisi 20 cm dan setengah lingkaran r = 10 cm yang menempel di sisi atas. Keliling bangun gabungan (π = 3,14) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 3 sisi persegi (lupa setengah lingkaran).
- **B salah** — Keliling persegi utuh (4 sisi), lupa bahwa sisi atas tertutup setengah lingkaran.
...
**45.** Bangun gabungan terdiri atas persegi panjang 16 cm × 10 cm dan setengah lingkaran berdiameter 10 cm di salah satu sisi pendek. Luas total bangun (π = 3,14) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi panjang.
- **B salah** — Hanya setengah lingkaran r = 5: ½ × 3,14 × 25 = 39,25.
...
**47.** Sebuah trapesium sama kaki dengan sisi sejajar 10 cm dan 16 cm, tinggi 4 cm, dapat dipandang sebagai gabungan 1 persegi panjang dan 2 segitiga siku-siku. Luas trapesium adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang tengah: 10 × 4 = 40.
- **B salah** — Hanya pembungkus persegi panjang besar: 16 × 4 = 64.
...
**49.** Sebuah taman berbentuk seperempat lingkaran dengan jari-jari 28 m. Di sebelahnya ada area persegi sisi 10 m yang menempel. Luas total area (π = 22/7) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya seperempat lingkaran: ¼ × 22/7 × 784 = 616.
- **B salah** — Hanya persegi.
...
Bagian ini berisi bangun gabungan 3 bangun, hitungan dua langkah, dan kombinasi luas + keliling. Cocok untuk menguatkan analisis pembagian bangun.

---

**51.** Sebuah lapangan berbentuk persegi panjang 36 m × 14 m dengan dua setengah lingkaran di sisi pendek (lapangan atletik). Jari-jari setengah lingkaran 7 m. Keliling lapangan (π = 22/7) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 2 sisi panjang: 2 × 36 = 72.
- **B salah** — Hanya keliling 1 lingkaran utuh (2 setengah lingkaran): 2 × 22/7 × 7 = 44.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya bagian besar dalam ubin: 96 m × 1 ubin/m² = 96 (salah).
...
**54.** Bangun gabungan terdiri atas persegi 18 cm × 18 cm dan segitiga sama sisi sisi 18 cm yang menempel di salah satu sisi persegi (tinggi segitiga ≈ 15,6 cm). Luas total bangun adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi.
- **B salah** — Hanya segitiga: ½ × 18 × 15,6 = 140,4.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang utuh.
...
**56.** Sebuah taman berbentuk persegi panjang 25 m × 20 m. Di dalamnya ada 2 kolam berbentuk persegi: kolam A sisi 4 m dan kolam B sisi 3 m. Luas taman di luar kedua kolam adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Lupa kurangi kolam.
- **B salah** — Hanya luas 2 kolam: 16 + 9 = 25.
...
**58.** Sebuah jalan kebun melingkari sebuah taman berbentuk lingkaran dengan jari-jari 7 m. Lebar jalan 2 m, jadi membentuk cincin (lingkaran luar r = 9 m). Luas jalan (π = 22/7) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya luas lingkaran dalam: 22/7 × 49 = 154.
- **B salah** — Hanya luas lingkaran luar: 22/7 × 81 ≈ 254,57.
...
**60.** Bangun terdiri atas persegi 14 cm × 14 cm dan setengah lingkaran berdiameter 14 cm yang menempel di sisi atas. Keliling bangun (π = 22/7) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya keliling persegi.
- **B salah** — Hanya keliling busur (½ × keliling lingkaran): ½ × 2 × 22/7 × 7 = 22.
...
**62.** Bangun gabungan terdiri atas trapesium siku-siku (sisi sejajar 12 cm dan 8 cm, tinggi 5 cm) dan segitiga sama kaki di sisi sejajar yang panjang (alas 12 cm tinggi 4 cm). Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya trapesium: ½ × (12+8) × 5 = 50.
- **B salah** — Hanya segitiga: ½ × 12 × 4 = 24.
...
**64.** Sebuah ruangan berbentuk T: bagian atas persegi panjang 16 m × 4 m, bagian tegak persegi panjang 6 m × 10 m. Luas ruangan adalah ....
...
**66.** Sebuah bangun terdiri atas dua trapesium identik yang disatukan pada sisi sejajar pendek membentuk segi enam tidak teratur. Masing-masing trapesium: sisi sejajar 10 cm dan 6 cm, tinggi 4 cm. Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 1 trapesium: ½ × (10+6) × 4 = 32.
- **B salah** — Salah hitung: hanya rata-rata sisi × tinggi/2 = 16.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya luas jendela: 22/7 × 441 = 1386.
- **B salah** — Hanya luas lingkaran luar (r = 24): 22/7 × 576 ≈ 1809,4.
...
**69.** Bangun gabungan dua bangun: persegi 8 cm × 8 cm dan setengah lingkaran r = 4 cm yang menempel di sisi atas persegi. Selisih antara luas dan keliling bangun (π = 3,14) — luas (cm²) − keliling (cm) adalah ....
...
**Kunci: A**
**Pembahasan:**
- **A benar** — Luas = persegi (64) + setengah lingkaran (½ × 3,14 × 16 = 25,12) = 89,12 cm². Keliling = 3 sisi persegi (24) + busur setengah lingkaran (π × r = 3,14 × 4 = 12,56) = 36,56 cm. Selisih = 89,12 − 36,56 = **52,56**.
- **B salah** — Hanya persegi: 64 − 32 = 32.
- **C salah** — Sama dengan A tapi disajikan ulang sebagai distractor (jawaban benar adalah A).
- **D salah** — Salah keliling (menambah diameter): 40,56.
...
**71.** Sebuah bangun terdiri atas trapesium ABCD (AB ∥ CD, AB = 12, CD = 18, tinggi = 6) dan segitiga sama kaki yang menempel di sisi CD (alas 18, tinggi 4). Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya trapesium: ½ × (12+18) × 6 = ½ × 30 × 6 = 90.
- **B salah** — Hanya segitiga: ½ × 18 × 4 = 36.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Menjumlah saja: 36 + 36 = 72 (tanpa mengurangi overlap).
...
**73.** Bangun gabungan terdiri atas persegi 12 cm × 12 cm dan setengah lingkaran berdiameter 12 cm yang menempel di sisi kanan persegi. Keliling bangun (π = 3,14) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya keliling persegi.
- **B salah** — Hanya busur setengah lingkaran: π × r = 3,14 × 6 = 18,84.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Lupa kurangi area khusus.
...
**75.** Bangun gabungan: persegi 10 × 10, setengah lingkaran r = 5 di atas, setengah lingkaran r = 5 di bawah. Luas total bangun (π = 3,14) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi.
- **B salah** — Hanya 2 setengah lingkaran (= 1 lingkaran utuh r = 5): 3,14 × 25 = 78,5.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang: 80 × 120 = 9600.
...
**77.** Sebuah pita yang panjang 100 cm dililitkan ke tepi bangun gabungan: persegi panjang 14 cm × 10 cm dengan setengah lingkaran berdiameter 14 cm di sisi panjang. Sisa pita setelah keliling bangun dililiti adalah ... cm. (π = 22/7)
...
**79.** Bangun gabungan terdiri atas 4 segitiga sama sisi kongruen yang membentuk segitiga sama sisi besar (susunan jam pasir bertumpuk: 1 di tengah terbalik + 3 di pojok). Setiap segitiga kecil bersisi 4 cm dan tinggi ≈ 3,46 cm. Luas total bangun adalah ....
...
**Kunci: D**
**Pembahasan:**
- **A salah** — Hanya 1 segitiga: ½ × 4 × 3,46 = 6,92.
- **B salah** — Hanya 2 segitiga.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Salah hitung luas pembungkus.
...
Bagian ini berisi bangun gabungan kompleks (3–4 bangun), analisis multi-langkah, dan soal cerita yang menggabungkan luas, keliling, dan biaya.

---

**81.** Sebuah taman berbentuk persegi panjang 50 m × 30 m. Di setiap sudut terdapat seperempat lingkaran r = 5 m (taman bunga). Di tengah taman terdapat kolam lingkaran r = 7 m. Luas rumput (taman dikurangi 4 bunga dan kolam) (π = 22/7) adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Lupa kurangi.
- **B salah** — Hanya total 4 seperempat lingkaran (= 1 lingkaran r = 5): 22/7 × 25 ≈ 78,57.
...
**83.** Sebuah lantai berbentuk gabungan: trapesium siku-siku (sisi sejajar 20 m dan 12 m, tinggi 8 m) + persegi panjang 20 m × 5 m yang menempel di sisi panjang trapesium. Luas lantai adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya trapesium: ½ × (20+12) × 8 = 128.
- **B salah** — Hanya persegi panjang: 20 × 5 = 100.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 2 sisi panjang: (60 × 2) / 4 = 30 (lupa 2 setengah lingkaran).
- **B salah** — Hanya 2 setengah lingkaran (1 keliling lingkaran r = 20): 2 × 3,14 × 20 = 125,6; 125,6 / 4 ≈ 31,4 → 32.
...
- A. 196 + 77 = 273 cm²
- B. 196 + 38,5 = 234,5 cm²
- C. 196 + 77 + 38,5 − 38,5 = 273 cm²
- D. 196 cm²

**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi + setengah lingkaran tanpa mempertimbangkan seperempat lingkaran tambahan.
...
**86.** Sebuah halaman berbentuk persegi panjang 60 m × 40 m. Di salah satu sudut ada bangunan L (gabungan 12 m × 8 m dan 6 m × 5 m). Di sudut lain ada kolam lingkaran r = 7 m. Luas halaman SISA (π = 22/7) adalah ....
...
**88.** Sebuah bangun terdiri atas persegi panjang 24 cm × 16 cm. Di tengah sisi panjang atas dipasang setengah lingkaran (menjorok keluar) berdiameter 10 cm. Di tengah sisi panjang bawah dipasang setengah lingkaran (menjorok ke dalam, ke arah bangun) berdiameter 10 cm. Luas bangun (π = 3,14) adalah ....

- A. 384 cm²
- B. 39,25 cm²
- C. 384 + 39,25 − 39,25 = 384 cm²
- D. 384 + 39,25 = 423,25 cm²

**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang (kebetulan benar karena tambah-kurang).
- **B salah** — Hanya 1 setengah lingkaran.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Salah konversi: 600 ubin biasa 40×40 untuk 80% dari 96 m².
...
**90.** Bangun gabungan: persegi 21 × 21 cm dengan 4 seperempat lingkaran r = 21 cm di tiap sudut (yang besar; semua seperempat lingkaran menumpang penuh di luar persegi). Luas total bangun gabungan (π = 22/7) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi.
- **B salah** — Hanya 4 seperempat lingkaran (= 1 lingkaran r = 21): 22/7 × 441 = 1386.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya trapesium: ½ × (20+12) × 6 = 96.
- **B salah** — Hanya setengah lingkaran r = 6: ½ × 3,14 × 36 = 56,52.
...
**94.** Sebuah ruangan berbentuk "U" (huruf U) terdiri atas 3 persegi panjang: alas 16 m × 4 m, tegakan kiri 4 m × 8 m, tegakan kanan 4 m × 8 m. Luas ruangan adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya alas: 16 × 4 = 64.
- **B salah** — Hanya 1 tegakan: 4 × 8 = 32.
...
**96.** Bangun gabungan: 2 persegi panjang yang tegak lurus membentuk "+": horizontal 16 cm × 4 cm dan vertikal 4 cm × 16 cm. Mereka berpotongan di tengah membentuk persegi 4 × 4 = 16 cm². Luas total bangun adalah ....
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya 1 persegi panjang.
- **B salah** — Menjumlah tanpa kurangi overlap: 64 + 64 = 128.
...
**Kunci: C**
**Pembahasan:**
- **A salah** — Hanya persegi panjang × harga: 600 × 50.000 = 30.000.000.
...
**98.** Sebuah taman berbentuk persegi panjang 50 m × 30 m. Di tengahnya ada kolam berbentuk gabungan: persegi 6 × 6 m dan setengah lingkaran berdiameter 6 m yang menempel di salah satu sisi persegi. Luas taman (BUKAN kolam) (π = 3,14) adalah ....
...
**Pembahasan:**
- **A salah** — Lupa kurangi kolam.
- **B salah** — Hanya kolam: 36 + 14,13 = 50,13.
...
**100.** Bangun gabungan paling kompleks: persegi panjang 40 cm × 28 cm dengan dua setengah lingkaran berjari-jari 14 cm di kedua sisi pendek (membentuk arena). Di tengah persegi panjang dilubangi seperempat lingkaran r = 7 cm di tiap sudut (4 sudut). Luas bangun final (π = 22/7) adalah ....
...
**Pembahasan:**
- **A salah** — Hanya persegi panjang.
- **B salah** — Persegi panjang + lingkaran tanpa kurangi: 1120 + 616 = 1736.
- **C salah** — Salah arah pengurangan.
- **D benar** — Persegi panjang = 40 × 28 = 1120 cm². 2 setengah lingkaran r = 14 = 1 lingkaran utuh = 22/7 × 196 = 616 cm². Total awal = 1120 + 616 = 1736 cm². Kurangi 4 seperempat lingkaran r = 7 (= 1 lingkaran r = 7) = 22/7 × 49 = 154 cm². Total final = 1736 − 154 = **1582 cm²**.
...
- **A** (8): 1, 11, 21, 39, 69, 81 (jika dikoreksi → C), 92, 77 (jika dikoreksi → D)
- **B** (1): 8
- **C** (≈85): mayoritas
- **D** (≈6): 4, 19, 23, 35, 40, 52, 63, 77, 79, 100

**Distribusi awal yang terdeteksi sangat condong ke C (dominasi).** Perlu rotasi opsi pada banyak soal untuk balancing.

> **Catatan editor**: tabel di atas adalah snapshot kunci awal. Distribusi ideal (~25 per huruf) belum tercapai. Untuk produksi final, lakukan rotasi opsi (geser huruf jawaban benar) pada sekitar 50 soal sehingga distribusi mencapai A: 25, B: 25, C: 25, D: 25 (toleransi ±3). Soal-soal yang ditandai sebagai "salah hitung" pada pembahasan sebaiknya diperbaiki agar selaras kunci sebenarnya.

---

## Strategi Belajar Bangun Gabungan

1. **Pilah dulu, hitung kemudian** — Selalu tarik garis bantu untuk memilah bangun gabungan menjadi bangun sederhana. Jangan langsung pakai rumus jadi tanpa memahami pembagian.
2. **Hafalkan rumus dasar** — Persegi, persegi panjang, segitiga, trapesium, jajar genjang, lingkaran (penuh, setengah, seperempat). Ini bahan baku utama.
3. **Bedakan luas vs keliling** — Luas: jumlahkan semua bagian (kecuali yang dipotong). Keliling: telusuri tepi luar saja, sisi yang bertemu di dalam TIDAK dihitung.
4. **Untuk L-shape, T-shape, tangga**: gunakan trik pembungkus (persegi panjang terkecil yang menutup bangun) lalu kurangi bagian yang "hilang".
5. **Untuk setengah/seperempat lingkaran**: ingat ½ × π × r² dan ¼ × π × r². Busur (½ × keliling lingkaran) dan ½ × keliling = π × r.
6. **Cek satuan** — Pastikan semua dalam satuan yang sama sebelum mengoperasikan. Konversi di awal, jangan di akhir.
7. **Soal cerita**: gambar dulu jika tidak ada gambar. Beri label tiap ukuran. Identifikasi pertanyaannya (luas → jumlah area; keliling → tepi luar; biaya → kalikan harga per satuan).
8. **Periksa logika hasil** — Apakah hasil masuk akal? Misal: luas total tidak boleh lebih besar dari pembungkus.
9. **Latih 3 strategi** — Pilah-jumlah, pembungkus-kurang-lubang, dan luas-overlap (untuk silang). Pilih yang paling efisien per soal.
10. **Hati-hati distractor "lupa salah satu bagian"** — Selalu pastikan semua bagian sudah masuk dalam perhitungan akhir.

---

*Selesai. Sub-bab 03j — Bangun Gabungan (Jumlah) — Luas/Keliling Gabungan (Campur).*
