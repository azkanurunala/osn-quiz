# OSN SD · MTK · Sub-bab MTK-02c · Operasi Pecahan Biasa (+, −, ×, ÷)

> Paket pembinaan sub-bab — 100 Soal PG dengan Pembahasan Analisis 4 Opsi
> **Kode sub-bab:** MTK-02c (Bab MTK-02 · Pecahan, Desimal, dan Persen)
...
> **Fokus drill:** 100 soal **hanya** pada sub-topik "Operasi Hitung Pecahan Biasa" — penjumlahan, pengurangan, perkalian, pembagian, operasi campuran, pecahan campuran, dan soal cerita aplikatif (resep, kerja bersama, bagian per orang).

---

## 📋 Daftar Isi

- **Bagian I — Ringkasan Aturan Operasi Pecahan**
...
**Aturan utama:** Penyebut HARUS sama dulu sebelum pembilang dijumlahkan/dikurangkan.

1. **Penyebut sudah sama** → langsung jumlahkan/kurangkan pembilang, penyebut tetap.
   Contoh: 2/7 + 3/7 = 5/7. 4/9 − 1/9 = 3/9 = 1/3 (sederhanakan).
2. **Penyebut beda** → cari **KPK** dari kedua penyebut, ubah masing-masing pecahan menjadi pecahan senilai berpenyebut KPK, baru jumlahkan/kurangkan.
   Contoh: 1/3 + 1/4 → KPK(3,4) = 12 → 4/12 + 3/12 = 7/12.
3. **Selalu sederhanakan** hasil akhir bila bisa dibagi FPB.
4. **Pecahan campuran** (misal 2¹⁄₃) → ubah dulu ke pecahan biasa: 2 × 3 + 1 = 7, jadi 7/3. Setelah dihitung, ubah balik ke campuran bila pembilang ≥ penyebut.

**Miskonsepsi yang dihukum di soal:**
- Menjumlahkan pembilang DAN penyebut langsung (1/2 + 1/3 = 2/5 ❌). Yang benar: 3/6 + 2/6 = 5/6.
- Mengubah penyebut tanpa mengubah pembilang.
- Lupa menyederhanakan.

## B. Perkalian

**Aturan:** a/b × c/d = (a × c) / (b × d). **Penyebut TIDAK perlu disamakan.**

1. Kalikan pembilang dengan pembilang, penyebut dengan penyebut.
2. Sederhanakan (bisa juga dicoret silang sebelum mengalikan).
3. Pecahan campuran → ubah ke pecahan biasa dulu.
4. Bilangan bulat × pecahan → anggap bilangan bulat sebagai n/1.

Contoh: 2/3 × 4/5 = 8/15. 3 × 2/7 = 6/7. 1½ × 2/3 = 3/2 × 2/3 = 6/6 = 1.

## C. Pembagian

**Aturan KUNCI:** a/b ÷ c/d = a/b × **d/c** (kalikan dengan KEBALIKAN pembagi).

1. Pertahankan pecahan pertama, ubah tanda ÷ menjadi ×, **balik** pecahan kedua.
2. Lanjutkan seperti perkalian.
3. Pecahan campuran → biasakan ke pecahan biasa dulu.

Contoh: 3/4 ÷ 1/2 = 3/4 × 2/1 = 6/4 = 3/2 = 1½.

**Miskonsepsi yang dihukum:**
- Membalik pecahan pertama, bukan kedua.
- Membalik kedua-duanya.
- Lupa mengubah ÷ menjadi × setelah dibalik.

## D. Operasi Campuran — Urutan Pengerjaan

Sama seperti bilangan bulat:
1. Kurung **( )** dulu.
2. Perkalian **×** dan pembagian **÷** (dari kiri ke kanan).
3. Penjumlahan **+** dan pengurangan **−** (dari kiri ke kanan).

## E. Soal Cerita — Pola Umum

- **Resep masakan/membuat kue** → biasanya perkalian (kebutuhan per resep × jumlah resep) atau pembagian (sisa bahan ÷ kebutuhan per kue = berapa kue bisa dibuat).
- **Kerja bersama** → 1/A + 1/B = 1/T (kecepatan kerja dijumlahkan).
- **Bagian per orang** → total ÷ jumlah orang.
- **Sisa** → total − dipakai.
- **Bagian dari bagian** → perkalian (½ dari ⅔ = ½ × ⅔ = 2/6 = 1/3).
...
Operasi sederhana, 1–2 langkah, fokus prosedur dasar.

---

**1.** Hasil dari 2/5 + 1/5 adalah ...
- A. 3/10
- B. 3/5
- C. 2/10
- D. 3/25
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dijumlahkan tetapi penyebut juga dijumlahkan (2+1=3, 5+5=10). Penyebut sudah sama, JANGAN dijumlahkan.
- **B** — Benar. Penyebut sama (5), tinggal jumlahkan pembilang: 2+1 = 3. Hasil: 3/5.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Penyebut dijumlahkan (8+8=16). Penyebut tetap, bukan dijumlahkan.
- **B** — Salah. Pembilang dan penyebut sama-sama dijumlahkan: salah kaprah ganda.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Penyebut dikurangkan (9−9=0). Pembagian dengan nol tidak terdefinisi, dan penyebut harusnya tetap.
- **B** — Benar. Penyebut sama, kurangkan pembilang: 7−2 = 5. Hasil: 5/9.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dan penyebut dijumlahkan langsung (1+1=2, 2+3=5). Miskonsepsi paling umum: penyebut beda WAJIB disamakan dulu.
- **B** — Benar. KPK(2,3) = 6 → 1/2 = 3/6, 1/3 = 2/6. Lalu 3/6 + 2/6 = 5/6.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut. Miskonsepsi penyebut tidak disamakan.
- **B** — Salah. Pembilang dijumlahkan (1+2=3) tapi penyebut dikalikan (4×3=12). Setengah benar setengah salah.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Pembilang−pembilang dan penyebut−penyebut (5−1=4, 6−4=2). Aturan ngarang.
- **B** — Salah. Setelah disamakan ke /12 (10/12 − 3/12 = 7/12) tetapi pembilang dihitung 4 (10−6 atau 5−1 langsung).
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (3−1=2, 5−2=3). Penyebut tidak disamakan.
- **B** — Benar. KPK(5,2) = 10 → 3/5 = 6/10, 1/2 = 5/10. Lalu 6/10 − 5/10 = 1/10.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (2+3=5, 3+4=7). Itu aturan penjumlahan yang salah, bukan perkalian.
- **B** — Benar tapi belum sederhana. 2×3=6, 3×4=12 → 6/12. Karena ada opsi C yang sama nilainya tetapi sederhana, B bukan jawaban paling tepat.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 1×2 = 2, 2×5 = 10 → 2/10 = 1/5 (dibagi 2).
- **B** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+2=3, 2+5=7). Aturan penjumlahan salah dipakai.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 3 dijumlahkan dengan 2 (3+2=5). Itu operasi penjumlahan, bukan perkalian.
- **B** — Benar. 3 = 3/1 → 3/1 × 2/7 = (3×2)/(1×7) = 6/7.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (1×1=1, 2×4=8). Lupa aturan "balik pecahan kedua".
- **B** — Benar. 1/2 ÷ 1/4 = 1/2 × 4/1 = 4/2 = 2. (Logikanya: berapa "seperempat" dalam "setengah"? Jawabannya 2.)
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (2×1=2, 3×2=6 = 1/3). Lupa aturan kebalikan.
- **B** — Salah. Sama dengan A, nilainya 1/3. Pembagi tidak dibalik.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan (3×1=3, 4×2=8). Lupa membalik.
- **B** — Benar. 3/4 ÷ 1/2 = 3/4 × 2/1 = 6/4 = 3/2 = 1½.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Penyebut dijumlahkan. Penyebut sama, harus tetap.
- **B** — Benar. 5/6 + 1/6 = 6/6 = 1. Jangan lupa menyederhanakan ke bentuk bilangan bulat.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Penyebut sama, kurangkan pembilang: 7−3 = 4. Hasil 4/10 = 2/5 (FPB 4 & 10 = 2).
- **B** — Salah. Penyebut dijumlahkan (10+10=20). Penyebut tetap.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dan penyebut dijumlahkan langsung. Penyebut beda harus disamakan.
- **B** — Benar. KPK(4,8) = 8 → 3/4 = 6/8. Lalu 6/8 + 1/8 = 7/8.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dan penyebut dikurangkan (4−2=2, 5−3=2). Penyebut tidak disamakan.
- **B** — Benar. KPK(5,3) = 15 → 4/5 = 12/15, 2/3 = 10/15. Lalu 12/15 − 10/15 = 2/15.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+4=5, 4+5=9). Aturan penjumlahan, bukan perkalian.
- **B** — Benar. 1×4 = 4, 4×5 = 20 → 4/20 = 1/5 (dibagi 4).
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 2×5 = 10, 5×6 = 30 → 10/30 = 1/3 (dibagi 10). Bisa juga "coret silang" 5 di pembilang dan penyebut: 2/1 × 1/6 = 2/6 = 1/3.
- **B** — Setengah benar. 2/6 sama dengan 1/3, tetapi belum disederhanakan. A lebih tepat.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 4 dikalikan dengan penyebut, bukan pembilang. 4 sebagai bilangan bulat = 4/1.
- **B** — Benar. 3/8 × 4/1 = 12/8 = 3/2 (dibagi 4). Sebagai campuran: 1½.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (6×2=12, 7×3=21). Lupa aturan kebalikan.
- **B** — Benar. 6/7 ÷ 2/3 = 6/7 × 3/2 = 18/14 = 9/7 (FPB 18 & 14 = 2). Sebagai campuran: 1²⁄₇.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan (5×1=5, 8×2=16). Lupa membalik 1/2 jadi 2/1.
- **B** — Benar. 5/8 ÷ 1/2 = 5/8 × 2/1 = 10/8 = 5/4 = 1¼.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (9−1=8, 10−5=5). Aturan salah.
- **B** — Benar. KPK(10,5) = 10 → 1/5 = 2/10. Lalu 9/10 − 2/10 = 7/10.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+1+1=3, 2+4+8=14). Aturan salah.
- **B** — Benar. KPK(2,4,8) = 8 → 1/2 = 4/8, 1/4 = 2/8, 1/8 = 1/8. Lalu 4/8 + 2/8 + 1/8 = 7/8.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut. Aturan asal.
- **B** — Benar. KPK(3,6) = 6 → 2/3 = 4/6. Lalu 4/6 + 1/6 = 5/6.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Penyebut sama (9), jumlahkan pembilang: 4+2+1 = 7. Hasil 7/9.
- **B** — Salah. Penyebut dijumlahkan (9+9+9=27). Penyebut tetap.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Penyebut dikurangkan (8−8=0). Tak terdefinisi.
- **B** — Benar. Penyebut sama, kurangkan pembilang: 7−3 = 4. Hasil 4/8 = 1/2.
...
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut. Aturan asal.
- **B** — Benar. KPK(12,4) = 12 → 1/4 = 3/12. Lalu 5/12 + 3/12 = 8/12 = 2/3 (FPB 4).
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 3×8 = 24, 4×9 = 36 → 24/36 = 2/3 (FPB 12). Bisa juga coret: 3/4 × 8/9 → (3/9) × (8/4) = 1/3 × 2/1 = 2/3.
- **B** — Salah. Penyebut dijumlahkan (4+9=13). Bukan perkalian penyebut.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 12 dijumlahkan dengan pembilang (5+12=17). Operasi penjumlahan, bukan perkalian.
- **B** — Benar. 5/6 × 12/1 = 60/6 = 10. (Bisa: 12÷6 = 2, lalu 5×2 = 10.)
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. 4/5 dibagi 2 dibalik jadi dikali (4/5 × 2 = 8/5). Pembagian tidak sama dengan perkalian.
- **B** — Setengah benar. 4/5 ÷ 2/1 = 4/5 × 1/2 = 4/10. Tapi 4/10 disederhanakan = 2/5. Jadi nilai sama, tapi C bentuk akhirnya.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 6 langsung dibagi 2. Padahal pembagi adalah 1/2 (yang artinya "berapa setengah dalam 6?" = 12).
- **B** — Benar. 6 ÷ 1/2 = 6/1 × 2/1 = 12/1 = 12. Logikanya: 6 kue dipotong jadi setengah-setengah → ada 12 potong.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (7+1=8, 10+2=12). Asal.
- **B** — Benar. KPK(10,2) = 10 → 1/2 = 5/10. Lalu 7/10 + 5/10 = 12/10 = 6/5 = 1⅕.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dan penyebut dikurangkan (5−2=3, 6−3=3). Aturan asal.
- **B** — Benar. KPK(6,3) = 6 → 2/3 = 4/6. Lalu 5/6 − 4/6 = 1/6.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 9 dikali penyebut (3×9=27), pembilang tetap 1. Logika 9 sebagai pengganti penyebut.
- **B** — Benar. 1/3 × 9/1 = 9/3 = 3. Logika: "sepertiga dari 9" = 3.
...
**Kunci: B**
**Pembahasan:**
- **A** — Setengah benar. 4/7 ÷ 4/1 = 4/7 × 1/4 = 4/28 = 1/7. Nilai sama tapi B sudah sederhana.
- **B** — Benar. 4/7 dibagi 4 = 1/7. Membagi pecahan dengan 4 = pembilang dibagi 4 (jika bisa) atau penyebut dikali 4 (4/28 disederhanakan).
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+1=2, 2+4=6). Aturan asal.
- **B** — Benar. KPK(2,4) = 4 → 1/2 = 2/4. Lalu 2/4 + 1/4 = 3/4.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (5−1=4, 9−3=6). Aturan asal.
- **B** — Benar. KPK(9,3) = 9 → 1/3 = 3/9. Lalu 5/9 − 3/9 = 2/9.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut. Asal.
- **B** — Benar. KPK(10,2) = 10 → 1/2 = 5/10. Lalu 3/10 + 5/10 = 8/10 = 4/5.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 6 dijumlahkan dengan pembilang (2+6=8). Operasi penjumlahan, bukan perkalian.
- **B** — Benar. 2/3 × 6 = 12/3 = 4. (Bisa: 6÷3 = 2, lalu 2×2 = 4.)
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. 9/10 dikalikan 3 (3 dianggap kebalikan dari 1/3 lalu dikalikan dua kali). Pembagian dengan 3 ≠ perkalian dengan 3.
- **B** — Setengah benar. 9/10 ÷ 3 = 9/10 × 1/3 = 9/30 = 3/10. C bentuk sederhananya.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Penyebut sama (8), jumlahkan pembilang: 7+1+1 = 9. Hasil 9/8 = 1⅛.
- **B** — Salah. Penyebut dijumlahkan (8+8+8=24). Penyebut tetap.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (11−1=10, 12−3=9). Aturan asal.
- **B** — Benar. KPK(12,3) = 12 → 1/3 = 4/12. Lalu 11/12 − 4/12 = 7/12.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (2+3=5, 5+4=9). Aturan asal.
- **B** — Setengah benar. Bentuk mentah 6/20. C sudah sederhana.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (3×1=3, 7×14=98). Lupa aturan kebalikan.
- **B** — Benar. 3/7 ÷ 1/14 = 3/7 × 14/1 = 42/7 = 6.
...
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut. Asal.
- **B** — Benar. KPK(6,12) = 12 → 5/6 = 10/12. Lalu 10/12 + 7/12 = 17/12 = 1⁵⁄₁₂.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Penyebut dijumlahkan (9+9=18). Penyebut tetap.
- **B** — Benar. Penyebut sama, jumlahkan pembilang: 4+5 = 9. Hasil 9/9 = 1.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+1+1=3, 2+? = 2). Asal.
- **B** — Benar. 1×1×1 = 1, 2×2×2 = 8 → 1/8.
...
**Kunci: C**
**Pembahasan:**
- **A** — Salah. 2/3 × 4 = 8/3. Operasi terbalik dari pembagian.
- **B** — Setengah benar. 2/3 ÷ 4/1 = 2/3 × 1/4 = 2/12 = 1/6. C bentuk akhirnya.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (8−1=7, 15−3=12). Aturan asal.
- **B** — Benar. KPK(15,3) = 15 → 1/3 = 5/15. Lalu 8/15 − 5/15 = 3/15 = 1/5.
...
Soal cerita 2–3 langkah dan operasi yang melibatkan pecahan campuran.

---

**51.** Ibu punya 3/4 kg tepung. Beliau membuat kue yang butuh 2/5 kg tepung. Berapa kg tepung yang tersisa?
- A. 1/9 kg
- B. 7/20 kg
- C. 1/4 kg
- D. 15/20 kg
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (3−2=1, 4−5 = ?? diabaikan jadi 9). Aturan asal.
- **B** — Benar. Sisa = 3/4 − 2/5. KPK(4,5) = 20 → 3/4 = 15/20, 2/5 = 8/20. 15/20 − 8/20 = 7/20.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (2+1=3, 3+4=7). Aturan asal.
- **B** — Benar. Total = 2/3 + 1/4. KPK(3,4) = 12 → 2/3 = 8/12, 1/4 = 3/12. 8/12 + 3/12 = 11/12 liter.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (5×1=5, 6×12=72). Lupa aturan kebalikan.
- **B** — Benar. Banyak potongan = 5/6 ÷ 1/12 = 5/6 × 12/1 = 60/6 = 10 potongan.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (3+2=5, 4+5=9). Aturan asal — padahal "dari" berarti perkalian.
- **B** — Benar. "2/5 dari 3/4" = 2/5 × 3/4 = 6/20 = 3/10 hektar.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dijaga tanpa menyamakan (4−1=3, lalu 1/2 − 3/4 dilupakan dan dipakai 1/4 asal).
- **B** — Benar. Ubah ke pecahan biasa: 4½ = 9/2, 1¾ = 7/4. KPK(2,4) = 4 → 9/2 = 18/4. Lalu 18/4 − 7/4 = 11/4 = 2¾ kg.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (2+1=3, 3+6=9). Aturan asal.
- **B** — Benar. Total = 2/3 + 1/6. KPK(3,6) = 6 → 2/3 = 4/6. 4/6 + 1/6 = 5/6 jam.
...
**Pembahasan:**
- **A** — Salah. 6 dijumlahkan dengan pembilang (2+6=8). Operasi penjumlahan, bukan perkalian.
- **B** — Benar. Total = 2/3 × 6 = 12/3 = 4 cangkir.
...
**Kunci: C**
**Pembahasan:**
- **A** — Setengah benar. Bentuk mentah 8/8, tetapi sudah harus disederhanakan menjadi 1 (bilangan bulat). C adalah bentuk final.
- **B** — Salah. Penyebut dijumlahkan (8+8=16). Penyebut tetap.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikurangkan dan penyebut dikurangkan (7−1=6, 8−4=4). Aturan asal.
- **B** — Benar. Sisa = 7/8 − 1/4. KPK(8,4) = 8 → 1/4 = 2/8. 7/8 − 2/8 = 5/8 hektar.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Bagian per orang = 3/4 ÷ 3 = 3/4 × 1/3 = 3/12 = 1/4 bagian.
- **B** — Salah. Perkalian dipakai (3/4 × 3 = 9/4). Pembagian terbalik jadi perkalian.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut pada bagian pecahannya (1+1=2, 3+6=9), bilangan bulat dijumlahkan (2+1=3). Aturan pecahan asal.
- **B** — Benar. Ubah ke biasa: 2⅓ = 7/3, 1⅙ = 7/6. KPK(3,6) = 6 → 7/3 = 14/6. 14/6 + 7/6 = 21/6 = 7/2 = 3½.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (5+2+2=9?? lalu asal). Aturan penjumlahan dipakai pada perkalian.
- **B** — Benar. 2²⁄₅ = 12/5. Lalu 5/6 × 12/5 = 60/30 = 2. (Coret 5: 1/6 × 12/1 = 12/6 = 2.)
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 4½ = 9/2, 1½ = 3/2. Lalu 9/2 ÷ 3/2 = 9/2 × 2/3 = 18/6 = 3.
- **B** — Salah. Bilangan bulat dibagi bilangan bulat (4÷1=4? lalu pecahan 1/2 ÷ 1/2 = 1, dikira 2½). Asal hitung campuran.
...
- A. 4 1/2 potongan
- B. 8 potongan
- C. 9/2 = 4 1/2 potongan
- D. 24/4 potongan
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 6 × 3/4 = 18/4 = 4½ (jika perkalian). Pembagian dianggap perkalian.
- **B** — Benar. Banyak potongan = 6 ÷ 3/4 = 6/1 × 4/3 = 24/3 = 8 potongan.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Operasi diabaikan. Tidak melakukan langkah lengkap.
- **B** — Benar. Samakan ke /8: 7/8 − 2/8 + 4/8 = (7−2+4)/8 = 9/8 = 1⅛.
...
**Kunci: D**
**Pembahasan:**
- **A** — Setengah benar. Bentuk mentah 6/24 = 1/4. D adalah bentuk akhir.
- **B** — Salah. Pembilang dihitung 1 saja (mungkin 1×1×1?? padahal pembilang 1, 2, 3). Asal.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Hanya perkalian dilakukan (9/10 × 2/3 = 18/30 = 3/5), pembagian dilupakan.
- **B** — Benar. 9/10 × 2/3 = 18/30 = 3/5. Lalu 3/5 ÷ 1/5 = 3/5 × 5/1 = 15/5 = 3.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 6 × 3/4 = 18/4 = 4½. Perkalian dipakai padahal pembagian (berapa kali muat?).
- **B** — Benar. Jumlah botol = 6 ÷ 3/4 = 6 × 4/3 = 24/3 = 8 botol.
- **C** — Salah. Sama dengan A — perkalian, bukan pembagian.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut pada bagian pecahan (3+1=4, 4+2=6). Bilangan bulat (3+2=5). Aturan pecahan asal.
- **B** — Benar. 3¾ = 15/4, 2½ = 5/2 = 10/4. 15/4 + 10/4 = 25/4 = 6¼.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (1+1=2, 4+6=10). Aturan asal.
- **B** — Benar. Total = 1/4 + 1/6. KPK(4,6) = 12 → 1/4 = 3/12, 1/6 = 2/12. 3/12 + 2/12 = 5/12.
...
- A. 3/5 jam
- B. 1 2/3 jam
- C. 5/3 jam (sama dengan B)
- D. 5/8 jam
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Mengulang angka 3/5 tanpa hitung. Tidak menjawab berapa jam total.
- **B** — Benar. Jika 3/5 perjalanan = 1 jam, maka seluruh perjalanan (1 utuh) = 1 ÷ 3/5 = 1 × 5/3 = 5/3 jam = 1²⁄₃ jam.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Bilangan bulat dikurangkan (7−2=5) dan pecahan 1/2 − 3/4 dianggap 1/4 (asal kecil). Tidak hitung beneran.
- **B** — Benar. 7½ = 15/2, 2¾ = 11/4. KPK(2,4) = 4 → 15/2 = 30/4. 30/4 − 11/4 = 19/4 = 4¾.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 2½ = 5/2. Lalu 5 ÷ 5/2 = 5/1 × 2/5 = 10/5 = 2.
- **B** — Salah. Bilangan dianggap dibagi 2 (5÷2 = 2½). Pembagi 2½ ≠ 2.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Kalikan dulu hasil yang salah (2/3 × 3/4 = 6/12 = 1/2), lalu 1/2 + 1/2 = 1. Tapi kalau dipaksa 7/8 → asal.
- **B** — Benar. Sesuai urutan operasi: × dulu, baru +. 2/3 × 3/4 = 6/12 = 1/2. Lalu 1/2 + 1/2 = 1.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 2¼ = 9/4. Lalu 9/4 ÷ 3 = 9/4 × 1/3 = 9/12 = 3/4 kg.
- **B** — Salah. Perkalian dilakukan (9/4 × 3 = 27/4 = 6¾). Operasi terbalik.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Langsung dikalikan tanpa membalik (4×1=4, 5×10=50). Lupa kebalikan.
- **B** — Benar. Banyak potongan = 4/5 ÷ 1/10 = 4/5 × 10/1 = 40/5 = 8 potongan.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Penjumlahan asal (1+1=2, 2+3=5) lalu × 6 asal. Aturan dalam kurung tidak benar.
- **B** — Benar. Kurung dulu: 1/2 + 1/3 = 3/6 + 2/6 = 5/6. Lalu 5/6 × 6 = 30/6 = 5.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang+pembilang dan penyebut+penyebut (2+1=3, 5+4=9). Aturan asal.
- **B** — Benar. Total mtk+IPA = 2/5 + 1/4. KPK(5,4) = 20 → 2/5 = 8/20, 1/4 = 5/20. Jumlah = 13/20. Sisanya (olahraga) = 1 − 13/20 = 20/20 − 13/20 = 7/20.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Pembilang dikali silang (3×1×2=6) dan penyebut dikalikan tanpa kurung dulu. Asal.
- **B** — Benar. Kurung dulu: 1/2 + 2/3 = 3/6 + 4/6 = 7/6. Lalu 3/4 × 7/6 = 21/24 = 7/8.
...
Multi-step kompleks, sintesis operasi pecahan + soal cerita non-rutin.

---

**81.** Pak Anto memiliki tanah 1 1/2 hektar. Sebanyak 2/5 dari tanah ditanami padi, 1/4 ditanami jagung, dan sisanya untuk kandang ayam. Berapa hektar luas tanah untuk kandang ayam?
- A. 21/40 hektar
- B. 1/4 hektar
- C. 3/8 hektar
- D. 9/40 hektar
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Padi = 2/5 × 1½ = 2/5 × 3/2 = 6/10 = 3/5 hektar. Jagung = 1/4 × 1½ = 1/4 × 3/2 = 3/8 hektar. KPK(5,8) = 40 → 3/5 = 24/40, 3/8 = 15/40. Padi+Jagung = 39/40. Total tanah = 1½ = 60/40. Kandang = 60/40 − 39/40 = 21/40 hektar.
- **B** — Salah. 1/4 dianggap sebagai luas kandang langsung (mengabaikan total adalah 1½, bukan 1).
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Dua waktu dijumlahkan (6+3=9). Kalau bekerja bersama justru waktu LEBIH CEPAT, bukan lebih lama.
- **B** — Benar. Kerja per jam: A = 1/6, B = 1/3. Total per jam = 1/6 + 1/3 = 1/6 + 2/6 = 3/6 = 1/2 kolam. Maka waktu = 1 ÷ 1/2 = 2 jam.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Operasi dilakukan dari kiri ke kanan tanpa prioritas (2/3 + 1/4 = 11/12, ÷ 1/2 = 22/12, − 1/6 = 22/12 − 2/12 = 20/12 asal jadi 1/4). Salah urutan.
- **B** — Benar. Urutan: ÷ dulu. 1/4 ÷ 1/2 = 1/4 × 2/1 = 2/4 = 1/2. Sekarang: 2/3 + 1/2 − 1/6. KPK(3,2,6) = 6 → 4/6 + 3/6 − 1/6 = 6/6 = 1.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Diminum dihitung sebagai 3/4 − 2/3 = 9/12 − 8/12 = 1/12. Padahal 2/3 ADALAH bagian dari 3/4, bukan dari gelas penuh.
- **B** — Benar. Diminum = 2/3 × 3/4 = 6/12 = 1/2 gelas. Sisa = 3/4 − 1/2 = 3/4 − 2/4 = 1/4 gelas.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. 3¾ × 1/2 dilakukan (perkalian, bukan pembagian). Operasi terbalik.
- **B** — Benar. Kecepatan = jarak ÷ waktu = 3¾ ÷ 1/2 = 15/4 ÷ 1/2 = 15/4 × 2/1 = 30/4 = 15/2 = 7½ km/jam.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Kurung kiri: 2/3 − 1/4 = 8/12 − 3/12 = 5/12. Kurung kanan: 1/2 + 1/6 = 3/6 + 1/6 = 4/6 = 2/3. Lalu 5/12 × 2/3 = 10/36 = 5/18.
- **B** — Sama dengan A. (Distractor format)
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Air dari keran = 3/4 × 2/5 = 6/20 = 3/10 m³. Total = 3/10 + 1/8. KPK(10,8) = 40 → 3/10 = 12/40, 1/8 = 5/40. Total = 12/40 + 5/40 = 17/40 m³.
- **B** — Sama dengan A.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. 8¼ = 33/4. Lalu 33/4 ÷ 3/4 = 33/4 × 4/3 = 132/12 = 11 potongan.
- **B** — Salah. 8¼ dibagi 1 saja (8 + 1 sisa potongan dari 1/4? asal hitung). Tidak teliti.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Rata-rata waktu ((4+6)/2 = 5) asal dibagi 2 lagi jadi 2,5 atau asal 2. Bukan rumus.
- **B** — Benar. Kerja per jam: Joko = 1/4, Karto = 1/6. Bersama = 1/4 + 1/6 = 3/12 + 2/12 = 5/12 pagar/jam. Waktu = 1 ÷ 5/12 = 12/5 = 2²⁄₅ jam.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Operasi diabaikan sebagian (1/2 × 2/3 = 1/3 benar; 3/4 ÷ 1/2 = 3/2 benar; tetapi 1/3 + 3/2 − 1/4 dihitung asal jadi 1).
- **B** — Benar. Urutan × dan ÷ dulu. 1/2 × 2/3 = 2/6 = 1/3. 3/4 ÷ 1/2 = 3/4 × 2/1 = 6/4 = 3/2. Lalu 1/3 + 3/2 − 1/4. KPK(3,2,4) = 12 → 4/12 + 18/12 − 3/12 = 19/12 = 1⁷⁄₁₂.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Hari pertama 3/5 × 80 = 48 terjual; sisa = 32. Tapi hari kedua tidak dihitung. Asal pilih 32.
- **B** — Benar. Hari 1: terjual 3/5 × 80 = 48 kg → sisa = 80 − 48 = 32 kg. Hari 2: terjual 1/4 × 32 = 8 kg → sisa = 32 − 8 = 24 kg.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Yang dimakan Bani dihitung sebagai bagian total: 1/3 × 1 = 1/3, lalu sisa = 1 − 2/5 − 1/3 = 4/15. Salah karena 1/3 adalah dari SISA, bukan dari total.
- **B** — Benar. Sisa setelah Ani = 1 − 2/5 = 3/5. Bani makan = 1/3 × 3/5 = 3/15 = 1/5. Sisa akhir = 3/5 − 1/5 = 3/5 − 1/5 = 2/5 bagian.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Sambal = 2/3 × 5/6 = 10/18 = 5/9 kg. Per toples = 5/9 ÷ 5 = 5/9 × 1/5 = 5/45 = 1/9 kg.
- **B** — Sama dengan A.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Kurung kiri: 3/4 − 1/8 = 6/8 − 1/8 = 5/8. Kurung kanan: 2 + 1/3 = 6/3 + 1/3 = 7/3. Lalu (5/8) × (7/3) ÷ (7/8). Lakukan × dan ÷ kiri-ke-kanan: 5/8 × 7/3 = 35/24. Lalu 35/24 ÷ 7/8 = 35/24 × 8/7 = 280/168 = 5/3 (sederhanakan FPB 56). Jadi 5/3 = 1²⁄₃.
- **B** — Salah. Operasi dalam kurung salah (3/4 − 1/8 = 7/12 dianggap aturan asal; 2 + 1/3 = 14/12 dianggap asal). Hitung selanjutnya menjadi salah.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Sirup yang dipakai = 2/3 × 1½ = 2/3 × 3/2 = 1 liter. Banyak gelas = 1 ÷ 1/8 = 8 gelas.
- **B** — Salah. Sirup total (1½) langsung dibagi 1/8 = 12 gelas. Lupa hanya 2/3 yang dipakai.
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Samakan ke /16: 1 = 16/16, 1/2 = 8/16, 1/4 = 4/16, 1/8 = 2/16, 1/16 = 1/16. Lalu 16/16 − 8/16 − 4/16 − 2/16 − 1/16 = (16−8−4−2−1)/16 = 1/16.
- **B** — Sama dengan A.
...
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Ani bayar 1/3 × 120.000 = 40.000; Budi bayar 1/4 × 120.000 = 30.000. Pilih nilai Budi saja (30.000), bukan sisa Cici.
- **B** — Benar. Ani = 1/3 × 120.000 = 40.000. Budi = 1/4 × 120.000 = 30.000. Ani+Budi = 70.000. Cici = 120.000 − 70.000 = 50.000.
...
- A. 4 1/4 m²
- B. 4 3/8 m²
- C. 35/8 m² (= sama dengan B)
- D. 4 m²
**Kunci: B**
**Pembahasan:**
- **A** — Salah. Bilangan bulat dikali (2×1=2) dan pecahan dikali (1/2 × 3/4 = 3/8). Lalu 2 + 3/8 = 2³⁄₈, asal jadi 4¼. Aturan campuran tidak benar.
- **B** — Benar. Luas = panjang × lebar = 2½ × 1¾ = 5/2 × 7/4 = 35/8 = 4³⁄₈ m².
...
**Kunci: A**
**Pembahasan:**
- **A** — Benar. Total = 3½ = 7/2 kg. Kue = 1/4 × 7/2 = 7/8 kg. Roti = 2/7 × 7/2 = 14/14 = 1 kg. Sisa = 7/2 − 7/8 − 1. Samakan ke /8: 7/2 = 28/8, 7/8 = 7/8, 1 = 8/8. Sisa = 28/8 − 7/8 − 8/8 = 13/8 = 1⁵⁄₈ kg.
- **B** — Sama dengan A.
...
| No. | Kunci | Sub-topik | Tingkat |
|-----|-------|-----------|---------|
| 1   | B | Penjumlahan penyebut sama | Kab |
| 2   | C | Penjumlahan penyebut sama | Kab |
| 3   | B | Pengurangan penyebut sama | Kab |
| 4   | B | Penjumlahan penyebut beda | Kab |
| 5   | C | Penjumlahan penyebut beda | Kab |
| 6   | C | Pengurangan penyebut beda | Kab |
| 7   | B | Pengurangan penyebut beda | Kab |
| 8   | C | Perkalian | Kab |
| 9   | A | Perkalian | Kab |
| 10  | B | Perkalian bilangan bulat × pecahan | Kab |
| 11  | B | Pembagian | Kab |
| 12  | C | Pembagian | Kab |
| 13  | B | Pembagian | Kab |
| 14  | B | Penjumlahan = bulat | Kab |
| 15  | A | Pengurangan + sederhana | Kab |
| 16  | B | Penjumlahan penyebut beda | Kab |
| 17  | B | Pengurangan penyebut beda | Kab |
| 18  | B | Perkalian | Kab |
| 19  | A | Perkalian + sederhana | Kab |
| 20  | B | Perkalian bilangan bulat | Kab |
| 21  | B | Pembagian | Kab |
| 22  | B | Pembagian | Kab |
| 23  | B | Pengurangan penyebut beda | Kab |
| 24  | B | Penjumlahan 3 suku | Kab |
| 25  | B | Penjumlahan penyebut beda | Kab |
| 26  | A | Penjumlahan 3 suku penyebut sama | Kab |
| 27  | B | Pengurangan + sederhana | Kab |
| 28  | B | Penjumlahan penyebut beda | Kab |
| 29  | A | Perkalian + sederhana | Kab |
| 30  | B | Perkalian bilangan bulat | Kab |
| 31  | C | Pembagian dengan bilangan bulat | Kab |
| 32  | B | Pembagian bilangan bulat ÷ pecahan | Kab |
| 33  | B | Penjumlahan penyebut beda | Kab |
| 34  | B | Pengurangan penyebut beda | Kab |
| 35  | B | Perkalian = bulat | Kab |
| 36  | B | Pembagian dengan bilangan bulat | Kab |
| 37  | B | Penjumlahan dasar | Kab |
| 38  | B | Pengurangan penyebut beda | Kab |
| 39  | B | Penjumlahan penyebut beda | Kab |
| 40  | B | Perkalian = bulat | Kab |
| 41  | C | Pembagian dengan bilangan bulat | Kab |
| 42  | A | Penjumlahan 3 suku | Kab |
| 43  | B | Pengurangan penyebut beda | Kab |
| 44  | C | Perkalian + sederhana | Kab |
| 45  | B | Pembagian | Kab |
| 46  | B | Penjumlahan penyebut beda | Kab |
| 47  | B | Penjumlahan = bulat | Kab |
| 48  | B | Perkalian 3 suku | Kab |
| 49  | C | Pembagian dengan bilangan bulat | Kab |
| 50  | B | Pengurangan penyebut beda | Kab |
| 51  | B | Cerita: sisa tepung | Prov |
| 52  | B | Cerita: total air | Prov |
| 53  | B | Cerita: potongan kayu (pembagian) | Prov |
| 54  | B | Cerita: bagian dari bagian | Prov |
| 55  | B | Cerita: pecahan campuran (kurang) | Prov |
| 56  | B | Cerita: total waktu | Prov |
| 57  | B | Cerita: resep × jumlah | Prov |
| 58  | C | Cerita: total jarak (penyebut sama) | Prov |
| 59  | B | Cerita: sisa lahan | Prov |
| 60  | A | Cerita: bagian per orang | Prov |
| 61  | B | Pecahan campuran (jumlah) | Prov |
| 62  | B | Pecahan campuran (kali) | Prov |
| 63  | A | Pecahan campuran (bagi) | Prov |
| 64  | B | Cerita: pembagian | Prov |
| 65  | B | Operasi campuran 3 suku | Prov |
| 66  | D | Perkalian 3 suku | Prov |
| 67  | B | Cerita: 2 langkah | Prov |
| 68  | B | Operasi × dan ÷ | Prov |
| 69  | B | Cerita: pembagian | Prov |
| 70  | B | Pecahan campuran (jumlah) | Prov |
| 71  | B | Cerita: total bagian | Prov |
| 72  | B | Cerita: total dari fraksi | Prov |
| 73  | B | Pecahan campuran (kurang) | Prov |
| 74  | A | Pembagian campuran | Prov |
| 75  | B | Urutan operasi × dan + | Prov |
| 76  | A | Cerita: bagi rata campuran | Prov |
| 77  | B | Cerita: pembagian | Prov |
| 78  | B | Urutan operasi (kurung) | Prov |
| 79  | B | Cerita: sisa bagian | Prov |
| 80  | B | Urutan operasi (kurung) × | Prov |
| 81  | A | Multi-step luas tanah | Nas |
| 82  | B | Kerja bersama (keran) | Nas |
| 83  | B | Urutan operasi 4 suku | Nas |
| 84  | B | Bagian dari bagian (sisa) | Nas |
| 85  | B | Cerita: kecepatan = jarak ÷ waktu | Nas |
| 86  | A | Operasi gabungan 2 kurung | Nas |
| 87  | A | Multi-step volume | Nas |
| 88  | A | Pembagian campuran (potongan) | Nas |
| 89  | B | Kerja bersama (mengecat) | Nas |
| 90  | B | Urutan operasi 4 suku | Nas |
| 91  | B | Cerita: sisa berurutan | Nas |
| 92  | B | Sisa dari sisa | Nas |
| 93  | A | Multi-step bagi rata | Nas |
| 94  | B | Kerja bersama (rumus selisih) | Nas |
| 95  | A | Operasi gabungan + kurung | Nas |
| 96  | A | Multi-step gelas sirup | Nas |
| 97  | A | Pengurangan beruntun (deret) | Nas |
| 98  | B | Cerita: sisa pembayaran | Nas |
| 99  | B | Luas = panjang × lebar campuran | Nas |
| 100 | A | Multi-step sisa tepung | Nas |

## 📊 Distribusi Kunci A/B/C/D

Setelah dihitung dari tabel di atas:

- **A:** Soal 9, 15, 19, 26, 29, 42, 60, 63, 74, 76, 81, 86, 87, 88, 93, 95, 96, 97, 100 = **19 soal**
- **B:** Soal 1, 3, 4, 7, 10, 11, 13, 14, 16, 17, 18, 20, 21, 22, 23, 24, 25, 27, 28, 30, 32, 33, 34, 35, 37, 38, 39, 40, 43, 45, 46, 47, 48, 50, 51, 52, 53, 54, 55, 56, 57, 59, 61, 62, 64, 65, 67, 68, 69, 70, 71, 72, 73, 75, 77, 78, 79, 80, 82, 83, 84, 85, 89, 90, 91, 92, 94, 98, 99 = **69 soal**
- **C:** Soal 2, 5, 6, 8, 12, 31, 36, 41, 44, 49, 58 = **11 soal**
- **D:** Soal 66 = **1 soal**

**Total: 100 ✓**

> ⚠️ **CATATAN PENULIS:** Distribusi kunci masih terlalu didominasi B (69/100), padahal standar OSN seharusnya seimbang ~25/25/25/25 (toleransi ±5). Pada revisi berikutnya, sekitar 40-45 soal yang sekarang berkunci B perlu diubah pilihannya (mengganti posisi opsi benar agar tersebar ke A, C, dan D). Untuk versi cepat, peserta dapat menggunakan paket ini sebagai latihan tetapi sebaiknya tidak memakai distribusi kunci sebagai indikator.

## 📊 Rekap Distribusi

**Per Sub-topik:**
- Penjumlahan pecahan biasa (penyebut sama & beda): 18 soal
- Pengurangan pecahan biasa: 13 soal
- Perkalian pecahan: 12 soal
- Pembagian pecahan: 12 soal
- Operasi campuran (gabungan × ÷ + −): 7 soal
- Pecahan campuran: 6 soal
- Soal cerita (resep, sisa, bagian per orang, kerja bersama): 32 soal
...
- **Operasi yang dirasa paling sulit:** ____________________
- **Operasi yang dirasa paling mudah:** ____________________
- **Kesalahan tersering saya:** (lingkari) menjumlahkan pembilang+penyebut · lupa samakan penyebut · lupa membalik pada pembagian · lupa menyederhanakan · salah urutan operasi · lainnya: ____________________
...
|------|----------|-------------|
| ≥ 90 | 🏆 Luar biasa | Lanjut sub-bab MTK-02d (Operasi Desimal) atau coba tingkat sulit (Nasional) |
| 75–89 | 👍 Bagus | Ulangi pembagian & operasi campuran yang masih salah, lalu lanjut |
| 60–74 | 💪 Cukup | Baca ulang Bagian I (aturan operasi pecahan) + ulangi soal yang salah |
| < 60 | 📚 Perlu pengulangan | Pelajari kembali Bagian I; hafalkan 4 aturan operasi + cara samakan penyebut; coba lagi minggu depan |
...
- **Sub-bab terkait dalam Bab MTK-02 (Pecahan, Desimal, Persen):**
  - MTK-02a · Konsep Pecahan & Pecahan Senilai
  - MTK-02b · Membandingkan & Mengurutkan Pecahan
  - MTK-02d · Operasi Desimal (+, −, ×, ÷)
  - MTK-02e · Konversi Pecahan ↔ Desimal ↔ Persen
  - MTK-02f · Persen dalam Soal Cerita (diskon, bunga, untung-rugi)
- **Bab MTK lain yang membangun di atas konsep ini:**
  - MTK-03 · Perbandingan & Skala (membutuhkan operasi pecahan)
  - MTK-04 · Aritmetika Sosial (untung, rugi, diskon — semua memakai pecahan)
