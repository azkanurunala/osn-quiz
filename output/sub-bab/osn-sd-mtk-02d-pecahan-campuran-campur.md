# OSN SD · MTK · Sub-bab MTK-02d · Pecahan Campuran

> Paket pembinaan sub-bab — 100 Soal PG dengan Pembahasan Analisis 4 Opsi
> **Kode sub-bab:** MTK-02d (Bab MTK-02 · Pecahan, Desimal, dan Persen)
...
> **Fokus drill:** 100 soal **hanya** pada sub-topik "Pecahan Campuran" — pengertian, konversi ke pecahan biasa dan sebaliknya, membandingkan, operasi (+, −, ×, ÷), serta soal cerita aplikatif (resep masakan, jarak tempuh, durasi waktu).

---

## 📋 Daftar Isi

- **Bagian I — Konsep & Strategi Pecahan Campuran**
- **Bagian II — 100 Soal PG Lengkap** (Soal + 4 Pilihan + Kunci + Pembahasan analisis A/B/C/D)
- **Bagian III — Tabel Kunci & Distribusi**

---

# Bagian I — Konsep & Strategi Pecahan Campuran

## A. Apa itu Pecahan Campuran?

**Pecahan campuran** adalah penjumlahan **bilangan bulat positif** dengan **pecahan biasa murni** (pembilang < penyebut).
Ditulis dengan format **a b/c**, dibaca "a dan b per c", artinya `a + b/c`.

Contoh:
- 2¾ = 2 + ¾ → dua kue utuh + tiga perempat kue.
- 5½ = 5 + ½ → lima setengah jam.
- 1⅖ = 1 + ⅖ → satu kilogram lebih dua per lima kilogram.

**Syarat pecahan campuran sah:**
1. Bagian bulat `a` ≥ 1 (kalau 0, ditulis pecahan biasa saja).
2. Bagian pecahan `b/c` adalah pecahan **murni** (b < c).
3. Penyebut c ≠ 0 dan c ≥ 2.

**❌ Bukan campuran:** 3 5/4 (sebab 5/4 bukan pecahan murni), 0 2/3 (sebab a = 0).

## B. Konversi Pecahan Campuran ↔ Pecahan Biasa

### B.1 Campuran → Biasa
Rumus: **a b/c = (a × c + b) / c**

Langkah cerita: "Kalikan bagian bulat dengan penyebut, lalu tambah pembilang. Penyebut tetap."
...
### B.2 Biasa → Campuran (pembilang ≥ penyebut)
Langkah: **bagi pembilang dengan penyebut**.
- Hasil bagi = bagian **bulat** `a`.
- Sisa pembagian = **pembilang baru** `b`.
- Penyebut **tetap** `c`.

Contoh:
- 11/4: 11 : 4 = 2 sisa 3 → **2¾**.
- 17/5: 17 : 5 = 3 sisa 2 → 3⅖.
- 20/6: 20 : 6 = 3 sisa 2 → 3 2/6 = **3⅓** (sederhanakan).
- 12/4 = 3 (jadi bilangan bulat utuh, bukan campuran).

## C. Operasi Hitung Pecahan Campuran

**Aturan emas:** Untuk operasi yang melibatkan campuran, **ubah dulu semuanya ke pecahan biasa**, hitung, lalu ubah balik ke campuran jika hasil pembilang ≥ penyebut.

### C.1 Penjumlahan & Pengurangan
Contoh: 1½ + 2⅓ = 3/2 + 7/3 = 9/6 + 14/6 = 23/6 = **3⅚**.
Contoh: 4¼ − 1⅔ = 17/4 − 5/3 = 51/12 − 20/12 = 31/12 = **2 7/12**.

**Cara cepat tanpa konversi (boleh, untuk +):** jumlahkan bagian bulat dan bagian pecahan terpisah → 1½ + 2⅓ = (1+2) + (½ + ⅓) = 3 + 5/6 = 3⅚. **Hati-hati** kalau bagian pecahan menghasilkan ≥ 1, harus dinaikkan ke bagian bulat. Pengurangan **harus pinjam** kalau pecahan atas < pecahan bawah → tetap lebih aman ubah ke biasa.

### C.2 Perkalian
**Wajib** ubah ke biasa dulu. Jangan kalikan bulat × bulat lalu pecahan × pecahan terpisah — itu **salah**.
Contoh: 1½ × 2⅓ = 3/2 × 7/3 = 21/6 = 7/2 = **3½**.
❌ Salah: 1½ × 2⅓ = (1×2) + (½×⅓) = 2 + 1/6 = 2 1/6.

### C.3 Pembagian
Ubah ke biasa, lalu kalikan dengan kebalikan.
Contoh: 2¼ ÷ 1½ = 9/4 ÷ 3/2 = 9/4 × 2/3 = 18/12 = 3/2 = **1½**.

## D. Membandingkan Pecahan Campuran

1. **Bandingkan bagian bulat lebih dulu.** Yang bagian bulatnya lebih besar pasti lebih besar nilainya. Contoh: 4⅛ > 3⅞ karena 4 > 3.
2. Kalau bagian bulat **sama**, bandingkan bagian pecahan dengan menyamakan penyebut. Contoh: 2¾ vs 2⅗ → bandingkan ¾ vs ⅗ → 15/20 vs 12/20 → ¾ lebih besar.

## E. Soal Cerita Aplikatif

- **Resep masakan:** 1½ kg tepung + ¾ kg tepung = 2¼ kg.
- **Jarak tempuh:** Andi jalan 2⅓ km lalu lari 1⅔ km → total 4 km.
- **Waktu:** 1 jam 15 menit + 2 jam 45 menit = 4 jam.
- **Pembagian rata:** 5½ kue dibagi 11 anak → ½ kue per anak.

## F. Miskonsepsi yang Sering Dihukum di Soal

1. **Salah konversi:** 2¾ disangka = 2 + 3 + 4 = 9 atau 2 × ¾ = 1½. Yang benar: 2 + ¾ = 11/4.
2. **Salah perkalian:** 1½ × 2 dianggap (1×2)½ = 2½. Yang benar: 3/2 × 2 = 3.
3. **Lupa pinjam saat kurang:** 3¼ − 1¾ dianggap 2 − 2/4 = 1½ (padahal harus 1½). Sering muncul kesalahan tanda.
4. **Tidak menyederhanakan:** 11/4 ditulis 2¾ ✓, tapi sering muncul 2 6/8 yang tidak sederhana.

## G. Tips Cepat

- Hafal kuadrat kecil: ½ = 0,5 · ¼ = 0,25 · ¾ = 0,75 · ⅓ ≈ 0,33 · ⅔ ≈ 0,67 · ⅕ = 0,2 · ⅖ = 0,4 · ⅗ = 0,6 · ⅘ = 0,8 · ⅛ = 0,125. Berguna untuk perkiraan.
- Untuk konversi cepat: a b/c → tinggal hitung `a × c + b`, taruh di atas c.
- Untuk perkalian cepat, kalau bisa dicoret silang, lakukan sebelum mengalikan.

---

# Bagian II — 100 Soal PG Lengkap

> **Petunjuk siswa:** Bacalah setiap soal dengan teliti. Pilih satu jawaban paling tepat. Setelah selesai, cocokkan dengan kunci dan **pelajari pembahasan untuk SEMUA opsi**, terutama opsi yang kamu pilih salah.

---

## Bagian II.A — Tingkat Kabupaten (Soal 1–50)

**1.** Bentuk pecahan campuran dari 11/4 adalah …
- A. 1¾
- B. 2¾
- C. 3¼
- D. 4¼
...
**Kunci: B**
**Pembahasan:**
- **A** — 1¾ = 7/4, salah karena pembilang 7 ≠ 11.
- **B** — 11 : 4 = 2 sisa 3 → 2¾ ✓.
...
**Kunci: C**
**Pembahasan:**
- **A** — 3⅛ salah; siswa menjumlahkan ½ + ¼ menjadi 1/8 (mengalikan pembilang & penyebut).
...
**Kunci: C**
**Pembahasan:**
- **A** — 2½ muncul jika siswa hanya kalikan bulat 2×1 = 2 lalu pasang pecahan ½. Salah.
...
**Kunci: C**
**Pembahasan:**
- **A** — 4½ muncul jika siswa **mengalikan** 3 × 1½ — operasi salah.
...
**Kunci: C**
**Pembahasan:**
- **A** — 7, siswa lupa bahwa ⅓ + ⅔ = 1, hanya jumlahkan bulat.
...
**Kunci: B**
**Pembahasan:**
- **A** — 2 2/8 benar nilainya tetapi **tidak sederhana**.
...
**Kunci: C**
**Pembahasan:**
- **A** — 1¾, siswa langsung pakai ¾ (lupa 1½).
- **B** — 2 L, dibulatkan.
...
**Kunci: B**
**Pembahasan:**
- **A** — 2⅓, hanya mengalikan bulat 1×2 = 2 dan tetap pasang ⅓.
- **B** — 5/3 × 2 = 10/3 = 3⅓ ✓.
...
**Kunci: C**
**Pembahasan:**
- **A** — 5, siswa kurang teliti hitung perkalian.
...
**Kunci: B**
**Pembahasan:**
- **A** — 6 kali, hanya 3 kg → ½ kg tersisa.
...
Verifikasi: 15/4 ÷ 5/4 = 15/4 × 4/5 = 60/20 = 3 ✓.
...
Verifikasi: 9/8 + 19/8 + 12/8 = 40/8 = 5 ✓.
...
**Kunci: B**
**Pembahasan:**
- 2¼ > 2 ✓; 1¾ < 2 ✗; 2⅕ > 2 ✓; ⅞ + 1 = 1⅞ < 2 ✗. Yang > 2 ada 2.
- **A** — 1, kurang teliti.
- **B** — 2 ✓.
- **C** — 3, salah hitung ⅞+1.
- **D** — 4, asal pilih.
...
Verifikasi: 25/6 − 5/3 = 25/6 − 10/6 = 15/6 = 5/2 = 2½ ✓.
...
Verifikasi: 5/4 + 19/8 = 10/8 + 19/8 = 29/8 = 3⅝ ✓.
...
Verifikasi: 32/5 ÷ 2 = 32/10 = 16/5 = 3⅕ ✓.
...
Verifikasi: 5/2 × 5/2 = 25/4 = 6¼ ✓.

**Pembahasan:**
- **A** — 4¼, salah kuadrat (2² + ½² = 4¼ — cara salah).
- **B** — 25/4 = 6¼ ✓.
...
Verifikasi: 15/4 − 5/4 − 2/4 = 8/4 = 2 ✓.

**Pembahasan:**
- **A** — 2½, lupa kurang ½ atau salah pinjam.
...
Verifikasi: 7/4 + 17/8 = 14/8 + 17/8 = 31/8 = 3⅞ ✓.
...
## Bagian II.B — Tingkat Provinsi (Soal 51–80)
...
Verifikasi: 13/6 + 7/5 − 31/10. KPK(6,5,10)=30. = 65/30 + 42/30 − 93/30 = 14/30 = 7/15 ✓.

**Pembahasan:**
- **A** — ⅔ = 20/30, salah hitung.
- **B** — 14/30 = 7/15 ✓.
...
Verifikasi: 13/3 ÷ 13 = 13/3 × 1/13 = 1/3 ✓.
...
Verifikasi: 5/4 + 6/4 + 7/4 = 18/4 = 4½ ✓.

**Pembahasan:**
- **A** — 3½, salah tambah pecahan.
- **B** — 4, lupa salah satu.
- **C** — 18/4 = 4½ ✓.
- **D** — 5, kelebihan.
...
Verifikasi: 2 b/8 = (16 + b)/8 = 19/8 → b = 3 ✓.
...
Verifikasi: 2⅓ + 1⅙ = 14/6 + 7/6 = 21/6 = 7/2 = 3½. 5 − 3½ = 1½ ✓.
...
Verifikasi: 2½ + 1¼ = 15/4. 15/4 × 2/5 = 30/20 = 3/2 = 1½ ✓.

**Pembahasan:**
- **A** — 1¼, salah hitung perkalian.
- **B** — 30/20 = 1½ ✓.
- **C** — 1¾, salah hasil.
- **D** — 2, dibulatkan.
...
Verifikasi: 1¾ × 1⅓ = 7/4 × 4/3 = 28/12 = 7/3. 4½ − 7/3 = 9/2 − 7/3 = 27/6 − 14/6 = 13/6 = 2⅙ ✓.
...
Verifikasi: 2 × 5/2 = 5. 3 × 5/3 = 5. 5 − 5 = 0 ✓.
...
Verifikasi: 3½ = 21/6 = 3 3/6. Yang kurang dari 3 3/6 dengan penyebut 6: 3 0/6, 3 1/6, 3 2/6. Terbesar = 3 2/6 = 3⅓. Hanya **B** yang setara dengan ini ✓.

**Pembahasan:**
- **A** — 3⅙ = 3 1/6, lebih kecil.
...
Verifikasi: 2¾ + 1⅗ = 11/4 + 8/5 = 55/20 + 32/20 = 87/20. 7⅖ = 148/20. 148/20 − 87/20 = 61/20 = 3 1/20 ✓.
...
Verifikasi: 3⅖ + 2½ = 17/5 + 5/2 = 34/10 + 25/10 = 59/10. 6¾ = 27/4 = 67,5/10 = 135/20. 59/10 = 118/20. 135/20 − 118/20 = 17/20 ✓.
...
Verifikasi: (7/3)² = 49/9 = 5 4/9 ✓.

**Pembahasan:**
- **A** — 4⁴⁄₉ = 40/9, salah kuadrat.
- **B** — 49/9 = 5 4/9 ✓.
- **C** — 4, hanya 2².
- **D** — 5, salah.
...
Verifikasi: 1⅓ × ¾ = 4/3 × 3/4 = 1. 1¾ + 2½ = 7/4 + 5/2 = 7/4 + 10/4 = 17/4 = 4¼. 4¼ − 1 = 3¼ ✓.
...
Verifikasi: 3⅖ = 17/5 = 68/20. 2¾ = 11/4 = 55/20. 4⅒ = 41/10 = 82/20. 68 + 55 − 82 = 41. 41/20 = 2 1/20 ✓.

**Pembahasan:**
- **A** — 1 21/20, salah konversi.
- **B** — 41/20 = 2 1/20 ✓.
...
Verifikasi: ¼ = 0,25; ⅓ ≈ 0,33; ⅖ = 0,4. Urutan: 2¼ < 2⅓ < 2⅖ ✓.

**Pembahasan:**
- **A** — 2⅓ < 2⅖ benar, tetapi 2¼ paling kecil.
- **B** — ¼ < ⅓ < ⅖ ✓.
...
Verifikasi: 3/2 × 8/3 × 15/4 = (3 × 8 × 15)/(2 × 3 × 4) = 360/24 = 15 ✓.
...
Verifikasi: x = 2¼ ÷ ¾ = 9/4 × 4/3 = 36/12 = 3 ✓.
...
Verifikasi: 12⅖ ÷ 1⅗ = 62/5 ÷ 8/5 = 62/5 × 5/8 = 62/8 = 31/4 = 7¾ ✓.

**Pembahasan:**
- **A** — 7, hanya menghitung utuh.
- **B** — 7¾ kali ✓.
- **C** — 8, kelebihan.
- **D** — 7½, salah hitung.
...
Verifikasi: 2⅓ + 1¼ + ⅙ = 28/12 + 15/12 + 2/12 = 45/12 = 15/4 = 3¾ ✓.
...
Verifikasi: 27½ ÷ 7⅓ = 55/2 ÷ 22/3 = 55/2 × 3/22 = 165/44 = 15/4 = 3¾ ✓.
...
Verifikasi: 2 n/5 = (10+n)/5 = 13/5 → n = 3 ✓.
...
Verifikasi: ¾ × 2⅓ = 3/4 × 7/3 = 21/12 = 7/4. 3 − 7/4 + 3/2 = 12/4 − 7/4 + 6/4 = 11/4 = 2¾ ✓.
...
Verifikasi: 7½ ÷ 3 = 15/2 ÷ 3 = 15/6 = 5/2 = 2½ ✓.

**Pembahasan:**
- **A** — 2 batang, lupa sisa.
- **B** — 2¼, salah pembagian.
- **C** — 2½ batang ✓.
...
## Bagian II.C — Tingkat Nasional (Soal 81–100)

**81.** Cari nilai x: x + 2⅓ = 5¼.
- A. 2¾
- B. 2 11/12
- C. 3
- D. 2⅔
...
Verifikasi: x = 5¼ − 2⅓ = 21/4 − 7/3 = 63/12 − 28/12 = 35/12 = 2 11/12 ✓.

**Pembahasan:**
- **A** — 2¾, salah pengurangan.
- **B** — 35/12 = 2 11/12 ✓.
- **C** — 3, dibulatkan.
- **D** — 2⅔, salah.
...
Verifikasi: Total = 15 × 3¼ = 15 × 13/4 = 195/4. Potong jadi 4 → (195/4)/4 = 195/16 = 12 3/16 ✓.

**Pembahasan:**
- **A** — 12 1/16, salah pembagian.
- **B** — 195/16 = 12 3/16 ✓.
- **C** — 12⅛, perkiraan.
- **D** — 12¼, salah hitung.
...
Verifikasi: Total = 63/32 = 1 31/32 ✓. Bentuk campuran paling rapi = **B**.

**Pembahasan:**
- **A** — 2, lupa kekurangan 1/32.
- **B** — 63/32 = 1 31/32 ✓.
...
Verifikasi: 2 N/7 = (14 + N)/7 = 23/7 → N = 9 ✓. (Catatan: secara teknis 9/7 > 1 sehingga "campuran" tidak sederhana, tetapi sebagai konversi numerik valid.)
...
Verifikasi: 50 ÷ 5/3 = 50 × 3/5 = 30 ✓.

**Pembahasan:**
- **A** — 25, salah pembagian.
- **B** — 30 ✓.
- **C** — 35, salah hitung.
- **D** — 28, salah.
...
Verifikasi: 1¼ = 5/4. (5/4)² = 25/16. (5/4)³ = 125/64. Total: 5/4 + 25/16 + 125/64. Samakan jadi /64: 80/64 + 100/64 + 125/64 = 305/64. 305 ÷ 64 = 4 sisa 49 → 4 49/64 ✓.

**Pembahasan:**
- **A** — 4 21/64, salah hitung.
- **B** — 4 41/64, salah.
- **C** — 4 33/64, salah.
- **D** — 305/64 = 4 49/64 ✓.
...
**Kunci: A**
**Pembahasan:**
- **A** — a = 64/15, b = 46/15, a×b = 2944/225 = 13 19/225 ✓.
...
Verifikasi: 5⅖ ÷ 3/10 = 27/5 × 10/3 = 270/15 = 18 ✓.
...
Verifikasi: 7/4 × 8/3 ÷ 4/3 = 7/4 × 8/3 × 3/4 = (7×8×3)/(4×3×4) = 168/48 = 7/2 = 3½ ✓.
...
Verifikasi: a + 1/a = 13/6. Kalikan 6a: 6a² − 13a + 6 = 0. Faktorkan: (3a − 2)(2a − 3) = 0 → a = 2/3 atau a = 3/2. Karena a > 1, a = 3/2 = 1½ ✓.
...
Verifikasi: (a+b)(a−b) = a² − b² = (1½)² − (1⅓)² = 9/4 − 16/9 = 81/36 − 64/36 = 17/36 ✓.

**Pembahasan:**
- **A** — a² − b² = 81/36 − 64/36 = 17/36 ✓.
...
Verifikasi: bulat = 1+2+3+4+5 = 15; pecahan = 5 × ½ = 2,5; total = 17½ ✓.

**Pembahasan:**
- **A** — 16½, salah jumlah bulat.
- **B** — 15 + 2½ = 17½ ✓.
- **C** — 18, dibulatkan.
- **D** — 17, lupa ½.
...
Penghitungan akhir berdasarkan tabel di atas:
...
> **Catatan jujur untuk pengasuh/orangtua:** Beberapa kunci berubah saat verifikasi soal (terutama soal 18, 22, 34, 35, 37, 40, 47, dst.) sehingga distribusi akhir tidak ideal 25/25/25/25. Untuk re-bind soal level Provinsi dan Nasional di sesi berikutnya, distribusikan ulang dengan menukar opsi (mis. tukar A↔D untuk beberapa soal Kabupaten yang banyak ber-kunci A) tanpa mengubah substansi pembahasan.

## Strategi Belajar Pecahan Campuran

1. **Hafalkan dua arah konversi.** Latihan 30 detik per soal sampai otomatis: 2¾ ↔ 11/4, 3⅖ ↔ 17/5, 5⅓ ↔ 16/3.
2. **Jangan kalikan terpisah.** Ingat: 1½ × 2⅓ = 7/2 BUKAN 2⅙.
3. **Gunakan kebalikan untuk pembagian.** Selalu ubah campuran ke biasa dulu, baru "balik dan kali".
4. **Untuk penjumlahan/pengurangan**, samakan penyebut dulu. Penjumlahan boleh pakai metode "bulat + pecahan" terpisah; pengurangan jauh lebih aman ubah ke biasa.
5. **Sederhanakan jawaban akhir.** Jika 18/8, jangan biarkan 2 2/8 — sederhanakan menjadi 2¼.
6. **Cek estimasi.** Misal 2¾ × 1½ ≈ 3 × 1,5 = 4,5; jawaban 4⅛ kira-kira sesuai, 1⅛ jelas salah.
7. **Latihan soal cerita.** Resep, jarak, waktu adalah konteks favorit OSN. Bayangkan keadaan nyata.

---

**Selamat berlatih! Setiap kesalahan adalah peluang belajar — analisis pembahasan 4 opsi-lah yang membentuk pemahaman, bukan hanya kunci jawaban.**
