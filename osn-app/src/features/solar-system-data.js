...
export const PLANETS = [
  ...
  { id: 'saturnus', name: 'Saturnus', order: 6, color: '#e3c78a', radius: 1.2, orbitRadius: 13.5, orbitSpeed: 0.034, texture: '/textures/2k_saturn.jpg', fact: 'Terkenal karena cincin lebar yang tersusun dari es dan batuan.' },
